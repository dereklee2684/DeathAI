      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/dashboard/profiles" className="text-gray-300 hover:text-white transition-colors">
                  Alumni Profiles
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/dashboard/users" className="text-gray-300 hover:text-white transition-colors">
                  User Management
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © 2025 Storiats. All rights reserved.
            </p>
